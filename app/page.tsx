    ...
    <>
      <main className="max-w-xl mx-auto px-6 py-20 relative min-h-screen font-light">
        <section className="flex items-center">
          ...
          />
          <div className="ml-4">
            <h1 className="mb-0.5 text-xl font-semibold text-slate-900 dark:text-slate-100">
              {generalData.name}
            </h1>
        ...
        <section className="print-keep-together my-14 text-sm">
        ...
        <div className="print-hide px-6 absolute left-0 bottom-6">
          <ThemeSwitch />
        </div>
      </main>
    </>
